...
import sarTrendsFoundation from '../assets/foundation.jpg'; // Adjust path if needed
import sarTrendsSerum from '../assets/serum.jpg';       // Adjust path if needed
import sarTrendsLipstick from '../assets/lipstick.jpg';   // Adjust path if needed
import sarTrendsBrushSet from '../assets/brush-set.jpg'; // Adjust path if needed
...
// --- 2. PRODUCT DATA MAPPING (PRICE renamed to RATE) ---

    // --- EXISTING PRODUCTS (RATE changed from price) ---
export const products = [
    { 
        id: 1,
        name: "Velvet Lip Gloss",
        category: "makeup",
        rate: 25.00, // Renamed from 'price'
...
        imageUrl: glamorousBrushesImage, // Added image
...
    },
    
    // --- NEWLY ADDED PRODUCTS (from imports) ---
    {
        id: 14,
...
    },
    ...
    // --- SAR TRENDS SIGNATURE PRODUCTS (IDs 90-93) ---
{
    id: 90, 
    name: "SarTrends Silk Foundation",
    category: "sartrends", // Required tag for filtering
    rate: "8.92", // ~PKR 2,499 
    imageUrl: sarTrendsFoundation, // Using the imported image variable
...
},
{
    ...
    category: "sartrends", // Required tag for filtering
    rate: "6.61", // ~PKR 1,850
    imageUrl: sarTrendsSerum, // Using the imported image variable
...
},
{
    ...
    category: "sartrends", // Required tag for filtering
    rate: "3.57", // ~PKR 999
    imageUrl: sarTrendsLipstick, // Using the imported image variable
...
},
{
    ...
    category: "sartrends", // Required tag for filtering
    rate: "11.43", // ~PKR 3,200
    imageUrl: sarTrendsBrushSet, // Using the imported image variable
...
    
    // --- FRAGRANCE PRODUCTS (IDs 101-114) ---
    {
        id: 101, 
        name: "Black Oudh 6ml",
        category: "fragrance", 
...
        name: "Janan",
        category: "fragrance",
        rate: 48.00, // Placeholder rate, you can adjust this
        description: "A captivating, floral oriental fragrance, often featuring notes of jasmine and warm woods.", // Placeholder description, you can adjust this
        imageUrl: jananImage,
        activeComponents: ["Jasmine Absolute", "Sandalwood", "Amber"], // Placeholder active components
        ingredients: [
            "Propylene Glycol", "Parfum (Fragrance)", "Benzyl Benzoate",
...
    },
    ...
    // --- NEW IMPORTED PRODUCTS (IDs 201-210) ---
    {
        id: 201, 
...
        category: "imported", 
        rate: 55.00,
        description: "High-quality imported shampoo for deep cleansing.",
        imageUrl: importedShampoImage,
        activeComponents: ["Keratin", "Biotin"],
...
        category: "imported", 
        rate: 70.00,
        description: "Concentrated imported serum for targeted skincare results.",
        imageUrl: importedSuremImage,
        activeComponents: ["Hyaluronic Acid", "Vitamin C"],
        ingredients: ["Water", "Glycerin", "Ascorbic Acid"]
    },
    {
        id: 205, 
        name: "Imported Cream",
        category: "imported", 
        rate: 65.00,
        description: "Rich, imported moisturizing cream for intense hydration.",
        imageUrl: importedCreamImage,
        activeComponents: ["Ceramides", "Shea Butter"],
        ingredients: ["Water", "Cetyl Alcohol", "Petrolatum"]
    },
    {
        id: 206, 
        name: "Imported Eyeliner",
        category: "imported", 
        rate: 25.00,
        description: "Precision imported eyeliner for long-lasting, dramatic eyes.",
        imageUrl: importedEyelinerImage,
        activeComponents: ["Carbon Black Pigment", "Smudge-Proof Formula"],
...
        category: "imported", 
        rate: 15.00,
        description: "Luxury imported soap with moisturizing and aromatic properties.",
        imageUrl: importedSoapImage,
        activeComponents: ["Natural Oils", "Botanical Extracts"],
        ingredients: ["Sodium Palmate", "Glycerin", "Fragrance"]
    },
    {
        id: 208, 
        name: "Imported Cleanser",
        category: "imported", 
        rate: 35.00,
        description: "Gentle imported facial cleanser for daily use.",
        imageUrl: importedCleanserImage,
        activeComponents: ["Salicylic Acid", "Green Tea Extract"],
        ingredients: ["Water", "Glycerin", "Coco-Betaine"]
    },
    {
        id: 209, 
        name: "Imported Lipstick",
        category: "imported", 
        rate: 40.00,
        description: "Vibrant, long-wearing imported lipstick with a smooth finish.",
        imageUrl: importedLisptickImage,
        activeComponents: ["Rich Pigments", "Conditioning Waxes"],
        ingredients: ["Castor Oil", "Carnauba Wax", "Pigments"]
    },
    {
        id: 210, 
        name: "Imported Face Gel",
        category: "imported", 
        rate: 50.00,
        description: "Lightweight imported face gel for oily and combination skin.",
        imageUrl: importedFaceGelImage,
        activeComponents: ["Aloe Vera", "Niacinamide"],
